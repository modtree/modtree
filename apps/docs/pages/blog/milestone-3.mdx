---
title: 'Milestone 3: Extension'
date: 2022/07/25
description: 'Extension: bugs squashed, edge features developed, problems encountered, and user testing'
tag: milestone
---
...
Click the sign in button at modtree.vercel.app. You can then choose between signing in with Google, Facebook, or Github.
