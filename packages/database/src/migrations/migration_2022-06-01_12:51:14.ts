...
export class migration1654059076669 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` varchar(36) NOT NULL, \`displayName\` varchar(255) NOT NULL, \`username\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`matriculationYear\` int NOT NULL, \`graduationYear\` int NOT NULL, \`graduationSemester\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Graph\` (\`id\` varchar(36) NOT NULL, \`userId\` varchar(36) NULL, \`degreeId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`graph_modules_placed_module\` (\`graphId\` varchar(36) NOT NULL, \`moduleId\` varchar(36) NOT NULL, INDEX \`IDX_edecdc3106863b709e515178b3\` (\`graphId\`), INDEX \`IDX_0dfbed7589128fdb16b5c10e6a\` (\`moduleId\`), PRIMARY KEY (\`graphId\`, \`moduleId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`graph_modules_hidden_module\` (\`graphId\` varchar(36) NOT NULL, \`moduleId\` varchar(36) NOT NULL, INDEX \`IDX_6af0127c032fc21654a4277826\` (\`graphId\`), INDEX \`IDX_142b842f7dcbc4eb38a796fbd9\` (\`moduleId\`), PRIMARY KEY (\`graphId\`, \`moduleId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`module\` DROP COLUMN \`description\``);
        await queryRunner.query(`ALTER TABLE \`module\` ADD \`description\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`Graph\` ADD CONSTRAINT \`FK_f0a9bf89839678324c47bd136f1\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`Graph\` ADD CONSTRAINT \`FK_c9aa8395a6af29b14701649d862\` FOREIGN KEY (\`degreeId\`) REFERENCES \`degree\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`graph_modules_placed_module\` ADD CONSTRAINT \`FK_edecdc3106863b709e515178b39\` FOREIGN KEY (\`graphId\`) REFERENCES \`Graph\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`graph_modules_placed_module\` ADD CONSTRAINT \`FK_0dfbed7589128fdb16b5c10e6ab\` FOREIGN KEY (\`moduleId\`) REFERENCES \`module\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`graph_modules_hidden_module\` ADD CONSTRAINT \`FK_6af0127c032fc21654a4277826e\` FOREIGN KEY (\`graphId\`) REFERENCES \`Graph\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`graph_modules_hidden_module\` ADD CONSTRAINT \`FK_142b842f7dcbc4eb38a796fbd96\` FOREIGN KEY (\`moduleId\`) REFERENCES \`module\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`graph_modules_hidden_module\` DROP FOREIGN KEY \`FK_142b842f7dcbc4eb38a796fbd96\``);
        await queryRunner.query(`ALTER TABLE \`graph_modules_hidden_module\` DROP FOREIGN KEY \`FK_6af0127c032fc21654a4277826e\``);
        await queryRunner.query(`ALTER TABLE \`graph_modules_placed_module\` DROP FOREIGN KEY \`FK_0dfbed7589128fdb16b5c10e6ab\``);
        await queryRunner.query(`ALTER TABLE \`graph_modules_placed_module\` DROP FOREIGN KEY \`FK_edecdc3106863b709e515178b39\``);
        ...
        await queryRunner.query(`ALTER TABLE \`Graph\` DROP FOREIGN KEY \`FK_c9aa8395a6af29b14701649d862\``);
        await queryRunner.query(`ALTER TABLE \`Graph\` DROP FOREIGN KEY \`FK_f0a9bf89839678324c47bd136f1\``);
        await queryRunner.query(`ALTER TABLE \`module\` DROP COLUMN \`description\``);
        await queryRunner.query(`ALTER TABLE \`module\` ADD \`description\` longblob NOT NULL`);
        await queryRunner.query(`DROP INDEX \`IDX_142b842f7dcbc4eb38a796fbd9\` ON \`graph_modules_hidden_module\``);
        await queryRunner.query(`DROP INDEX \`IDX_6af0127c032fc21654a4277826\` ON \`graph_modules_hidden_module\``);
        await queryRunner.query(`DROP TABLE \`graph_modules_hidden_module\``);
        await queryRunner.query(`DROP INDEX \`IDX_0dfbed7589128fdb16b5c10e6a\` ON \`graph_modules_placed_module\``);
        await queryRunner.query(`DROP INDEX \`IDX_edecdc3106863b709e515178b3\` ON \`graph_modules_placed_module\``);
